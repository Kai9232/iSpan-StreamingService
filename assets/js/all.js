...
function playVideo() {
  $("#player")[0].src = getSrc() + "autoplay=1&mute=1"; // console.log($("#player")[0].src);
}

function stopVideo() {
  $("#player")[0].src = getSrc() + "autoplay=0"; // console.log($("#player")[0].src);
}

var topButton = document.getElementById("topBtn"); // When the user scrolls down 20px from the top of the document, show the button
